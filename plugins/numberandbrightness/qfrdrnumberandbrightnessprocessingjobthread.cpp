...
QMutex* QFRDRNumberAndBrightnessProcessingJobThread::mutexFilename=NULL;

QFRDRNumberAndBrightnessProcessingJobThread::QFRDRNumberAndBrightnessProcessingJobThread(QFPluginServices *services, QObject *parent) :
    QThread(parent)
{
...
QFRDRNumberAndBrightnessProcessingJobThread::~QFRDRNumberAndBrightnessProcessingJobThread() {
    if (backgroundImage) qfFree(backgroundImage);
    if (backgroundImageStd) qfFree(backgroundImageStd);
}

double QFRDRNumberAndBrightnessProcessingJobThread::durationMS() const {
    return duration;
}

double QFRDRNumberAndBrightnessProcessingJobThread::durationS() const {
    return duration;
}

QList<QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo> QFRDRNumberAndBrightnessProcessingJobThread::getAddFiles() const {
    return addFiles;
}

IMFCSJob QFRDRNumberAndBrightnessProcessingJobThread::getJob() const {
    return job;
}

QStringList QFRDRNumberAndBrightnessProcessingJobThread::getImageFilterList(QFPluginServices* pluginservices)  {
    QStringList l;
    int i=0;
...
QStringList QFRDRNumberAndBrightnessProcessingJobThread::getImageFormatNameList(QFPluginServices* pluginservices)  {
     QStringList l;
     int i=0;
     QFImporterImageSeries* r=NULL;
     while ((r=getImageReader(i, pluginservices))!=NULL) {
...
QFImporterImageSeries* QFRDRNumberAndBrightnessProcessingJobThread::getImageReader(int idx, QFPluginServices* pluginservices)  {
    QFImporterImageSeries* r=NULL;
...
int QFRDRNumberAndBrightnessProcessingJobThread::getImageReaderCount(QFPluginServices* pluginservices) {
    QStringList imp=pluginservices->getImporterManager()->getImporters<QFImporterImageSeries*>();
    return imp.size();
}

int QFRDRNumberAndBrightnessProcessingJobThread::status() const {
    return m_status;
}

void QFRDRNumberAndBrightnessProcessingJobThread::cancel() {
    was_canceled=true;
    if (!isRunning()) {
        m_status=-1;
...
void QFRDRNumberAndBrightnessProcessingJobThread::init(IMFCSJob job) {
    this->job=job;
    m_status=0;
    was_canceled=false;
    addFiles.clear();
...
QString QFRDRNumberAndBrightnessProcessingJobThread::replacePostfixSpecials(const QString& input, int counter) const {
    QString cnt="";
...
bool QFRDRNumberAndBrightnessProcessingJobThread::saveCorrelationCSV(const QString &filename, double *corrTau, double **corrs, double** correrrs, uint32_t corrN, uint32_t N_in, uint32_t width, uint32_t height, double input_length, QString& error, int progress_steps, double segmentLengthSeconds) {
...
bool QFRDRNumberAndBrightnessProcessingJobThread::saveCorrelationBIN(const QString &filename, double *corrTau, double **corrs, double** correrrs, uint32_t corrN, uint32_t N_in, uint32_t width, uint32_t height, double **corrSegments, QString& error, int progress_steps, double segmentLengthSeconds) {
    QFile f(filename);
...
void QFRDRNumberAndBrightnessProcessingJobThread::correlate_series(float* image_series, uint32_t frame_width, uint32_t frame_height, uint32_t shiftX, uint32_t shiftY, uint64_t frames, double **ccf_tau_io, double **ccf_io, double **ccf_std_io, uint32_t &ccf_N, const QString& message, uint32_t increment_progress, double **ccf_segments_io) {
    ccf_N=job.S*job.P;
...
inline double QFRDRNumberAndBrightnessProcessingJobThread_bleachCorrect(const double& intensity, const double& expT, const double& exp0) {
    return intensity/sqrt(expT/exp0)+exp0*(1.0-sqrt(expT/exp0));
}

double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectExp(const double& intensity, int i, double t) {
    double expT=bleachAmplitude[i]*exp(-(double)t/bleachTime[i]);
    double exp0=bleachAmplitude[i];
    return QFRDRNumberAndBrightnessProcessingJobThread_bleachCorrect(intensity, expT, exp0);
}

double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectExpPoly2(const double& intensity, int i, double t) {
    double expT=bleachAmplitude[i]*exp(-((double)t+bleachPoly2[i]*qfSqr((double)t))/bleachTime[i]);
    double exp0=bleachAmplitude[i];
    return QFRDRNumberAndBrightnessProcessingJobThread_bleachCorrect(intensity, expT, exp0);
}

double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectExpPoly3(const double& intensity, int i, double t) {
    double expT=bleachAmplitude[i]*exp(-((double)t+bleachPoly2[i]*qfSqr((double)t)+bleachPoly3[i]*qfCube((double)t))/bleachTime[i]);
    double exp0=bleachAmplitude[i];
    return QFRDRNumberAndBrightnessProcessingJobThread_bleachCorrect(intensity, expT, exp0);
}

double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectExpPoly4(const double& intensity, int i, double t) {
...
double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectExpPoly5(const double& intensity, int i, double t) {
...
double QFRDRNumberAndBrightnessProcessingJobThread::bleachCorrectDblExp(const double& intensity, int i, double t) {
...
void QFRDRNumberAndBrightnessProcessingJobThread::correlate_loadall() {
    ...
    if (!was_canceled) {
        ...
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected(frame_width*frame_height);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected_dv0(frame_width*frame_height/2);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected_dv1(frame_width*frame_height/2);
    ...
    if (m_status==1 && !was_canceled) {
        ...
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state(frame_width*frame_height);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv1(frame_width*frame_height/2);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv2(frame_width*frame_height/2);
        statistics.clear();
...
void QFRDRNumberAndBrightnessProcessingJobThread::average_ccfs(double** acf, double** acf_std, uint32_t acf_N, uint32_t frame_width, uint32_t frame_height, uint32_t segments) {
...
void QFRDRNumberAndBrightnessProcessingJobThread::prepare_ccfs(QList<MultiTauCorrelator<double, double> *> &acfjk, QList<correlatorjb<double, double> *> &acfjb, double **acf, double **acf_std, double **acf_t, uint32_t& acf_N, uint32_t frame_width, uint32_t frame_height, uint32_t segments) {
    if (job.correlator==CORRELATOR_MTAUALLMON) {
        for (register uint32_t i=0; i<frame_width*frame_height; i++) {
...
void QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics(QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state &state, float *frame_data, uint32_t frame_width, uint32_t frame_height, uint32_t frame, uint32_t frames, float **average_frame, float **sqrsum_frame, float **video, uint32_t &video_frame_num, float &frames_min, float &frames_max, QFRDRNumberAndBrightnessProcessingJobThread::StatisticsDataset &statistics, bool isBackground)
{
...
void QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_dv2_statistics(QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state &state1, QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state &state2, float *frame_data, uint32_t frame_width, uint32_t frame_height, uint32_t frame, uint32_t frames, QFRDRNumberAndBrightnessProcessingJobThread::StatisticsDataset &statistics1, QFRDRNumberAndBrightnessProcessingJobThread::StatisticsDataset &statistics2, bool isBackground)
{
    uint32_t dummyUI32;
    float dummyF;
...
bool QFRDRNumberAndBrightnessProcessingJobThread::saveStatistics(const QString &filename, const QString& filename_plot, const QFRDRNumberAndBrightnessProcessingJobThread::StatisticsDataset &statistics, const QString &title, QString *error)
{
    bool ok=true;
    QFile f(filename);
    if (f.open(QIODevice::WriteOnly|QIODevice::Text)) {
...
void QFRDRNumberAndBrightnessProcessingJobThread::correlate_loadsingle() {
    ...
    if (!was_canceled) {
        ...
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected(frame_width*frame_height);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected_dv1(frame_width*frame_height/2);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_uncorrected_dv2(frame_width*frame_height/2);
        statistics_uncorrected.clear();
        dv_statistics_uncorrected[0].clear();
        dv_statistics_uncorrected[1].clear();
        uint32_t video_frame_num=0;
    ...
    if (!was_canceled && m_status==1) {
        ...
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state(frame_width*frame_height);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv1(frame_width*frame_height);
        QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv2(frame_width*frame_height);
        statistics.clear();
        dv_statistics[0].clear();
        dv_statistics[1].clear();
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExpLin( double t, const double *par )
{
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExpPoly2Lin( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fDblExp( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExp( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
    return A*exp(-t/tau);
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExpPoly3Lin( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
    const double f=par[2];
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExpPoly4Lin( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
    const double f=par[2];
...
static double QFRDRNumberAndBrightnessProcessingJobThread_fExpPoly5Lin( double t, const double *par )
{
    const double A=par[0];
    const double tau=par[1];
    const double f=par[2];
...
void QFRDRNumberAndBrightnessProcessingJobThread::calcBleachCorrection(float* fit_frames, double* fit_t, int NFitFrames) {
    if (job.bleach==BLEACH_EXP) {
        ...
        if (fit_frames && fit_t && NFitFrames>2) {
            for (uint32_t i=0; i<frame_width*frame_height; i++) {
                ...
                double pA=0, pB=0;
                statisticsIterativelyReweightedLeastSquaresRegression(fit_t, fit_I, NFitFrames, pA, pB);
...
void QFRDRNumberAndBrightnessProcessingJobThread::calcBackgroundCorrection() {
    if (backgroundImage) qfFree(backgroundImage);
    if (backgroundImageStd) qfFree(backgroundImageStd);
    ...
    QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state(frame_width*frame_height);
    QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv0(frame_width*frame_height/2);
    QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state stat_state_dv1(frame_width*frame_height/2);
...
QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo::Fileinfo(const QString &filename, const QString &role, int internalDualViewMode, int dualViewID, bool isNandB, const QString& group)
{
    ...
    this->filetype=QFRDRNumberAndBrightnessProcessingJobThread::ftCorrelation;
}

QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo QFRDRNumberAndBrightnessProcessingJobThread::getFileInfo(const QString &filename, const QString& filenameEvalSettings, const QString &role, const QString &group)
{
    QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo i;
    i.filename=filename;
...
QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo QFRDRNumberAndBrightnessProcessingJobThread::getFileInfo(const QString &filename, const QString &filenameEvalSettings, const QString &role, int dualViewID, const QString& group)
{
    QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo i;
    i.filename=filename;
    i.filenameEvalSettings=filenameEvalSettings;
...
QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo QFRDRNumberAndBrightnessProcessingJobThread::getFileInfoNandB(const QString &filename, const QString &filenameVar, const QString &filenameBack, const QString &filenameBackVar, const QString& filenameEvalSettings, const QString &role, int dualViewID, const QString& group)
{
    QFRDRNumberAndBrightnessProcessingJobThread::Fileinfo i;
    i.filename=filename;
    ...
    i.dualViewID=dualViewID;
    i.internalDualViewMode=job.dualViewMode;
    i.filetype=QFRDRNumberAndBrightnessProcessingJobThread::ftNandB;
    i.props=props;
    i.comment=comment;
...
QString QFRDRNumberAndBrightnessProcessingJobThread::getGroupName() const
{
    return outputFilenameBase;
}

void QFRDRNumberAndBrightnessProcessingJobThread::StatisticsDataset::clear()
{
    time.clear();
    min.clear();
    max.clear();
...
QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state::contribute_to_statistics_state(int size)
{
    sum=0;
    sum2=0;
    sframe_min=0;
...
QFRDRNumberAndBrightnessProcessingJobThread::contribute_to_statistics_state::~contribute_to_statistics_state()
{
    qfFree(video_frame);
}
