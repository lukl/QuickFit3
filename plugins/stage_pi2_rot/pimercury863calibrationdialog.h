...
class QFExtensionLinearStagePI2Rot; // forward
...
class PIMercury863CalibrationDialog : public QFDialog {
    ...
    public:
        /** Default constructor */
        PIMercury863CalibrationDialog(QWidget* parent, QFExtensionLinearStagePI2Rot* stage, int axis);
        /** Default destructor */
    ...
    protected slots:
        ...
        void resetCal();
    protected:
        QFExtensionLinearStagePI2Rot* stage;
