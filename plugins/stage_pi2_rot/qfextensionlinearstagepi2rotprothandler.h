...
#ifndef QFEXTENSIONLINEARSTAGEPI2ROTPROTHANDLER_H
#define QFEXTENSIONLINEARSTAGEPI2ROTPROTHANDLER_H
...
/*! \brief tool class to handle the PI Mercury serial connection protocol
...
*/
class QFExtensionLinearStagePI2RotProtHandler {
    public:
        QFExtensionLinearStagePI2RotProtHandler(QFSerialConnection* com, QMutex* mutexSerial, QString name);
...
#endif // QFEXTENSIONLINEARSTAGEPI2ROTPROTHANDLER_H
