                ...
                if (command=="math" || command=="bmath" || command=="mathb") {
                    if (dontCreatePics)  {
                        if (command=="bmath" || command=="mathb") {
                            result=result.replace(rxLaTeX.cap(0), QString("<blockquote><font size=\"+2\"><tt><i>%1</i></tt></font></blockquote>").arg(qfHTMLEscape(latex)));
                            replaced=true;
                        } else {
                            result=result.replace(rxLaTeX.cap(0), QString("<tt><i>%1</i></tt>").arg(qfHTMLEscape(latex)));
                            replaced=true;
                        }
                    } else {
